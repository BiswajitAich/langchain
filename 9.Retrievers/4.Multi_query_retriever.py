...
Result 2:
Content: My technical skills include Python, JavaScript, React, TensorFlow, and PyTorch. I'm particularly interested in Natural Language Processing and Machine Learning applications.
Metadata: {'importance': 'high', 'category': 'skills'}

Result 3:
Content: I am studying B.Tech in Computer Science and Engineering at Academy of Technology. My expected graduation is in 2026.
Metadata: {'category': 'education', 'importance': 'high'}

Result 4:
Content: Currently, I'm practicing LangChain for building conversational AI systems and exploring vector databases for efficient information retrieval.
Metadata: {'category': 'current_activity', 'importance': 'high'}
